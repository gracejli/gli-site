      ...
      */}
      ...
      <div className="pointer-events-none fixed bottom-4 right-4 z-20 flex max-w-xs flex-col items-end gap-2 text-right">
        ...
        <button
          ...
          className="pointer-events-auto rounded-full border border-amber-300/70 bg-black/60 px-4 py-1 text-xs font-fe uppercase tracking-wide text-amber-100 shadow-lg backdrop-blur transition hover:bg-amber-400/80 hover:text-black"
        >
          shuffle background
        </button>
      </div>
