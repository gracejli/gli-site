          ...
          {[1, 2, 3].map((i) => (
            <div key={i} className="mb-12 scroll-mt-24 w-full">
              <div className="flex flex-col md:flex-row gap-4 items-start w-full">
                <div className="relative shrink-0 w-32 h-32 md:w-24 md:h-24 overflow-hidden rounded-xl border-2 border-dashed border-[#e6dfa8]">
                  <div
                ...
                <div className="flex flex-1 animate-pulse flex-col gap-3 pt-1 w-full">
                  ...
                  <div className="h-4 w-1/2 rounded bg-gray-200/60 dark:bg-gray-700/60" />
                </div>
              </div>
            </div>
          ))}
