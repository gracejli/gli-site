...
const DIALOG_FLOW = {
  initial: {
    title: "hello user!",
    message:
      "this pop up only happens if you've clicked 3 times in thirty seconds. scientists call this the threshold for doomscrolling.",
    buttons: [
...
const TELEPORT_CLICK_THRESHOLD = 3;
