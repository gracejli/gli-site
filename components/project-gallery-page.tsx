...
const proseClass =
  "space-y-6 text-[15px] leading-relaxed max-w-md font-fe [&_h2]:text-base [&_h2]:[&_h2]:mb-3 [&_h2]:mt-0 [&_h3]:text-sm [&_h3]:font-fe [&_h3]:mb-2 [&_h3]:mt-4 first:[&_h2]:mt-0 [&_h4]:text-sm [&_h4]:font-fe [&_h4]:font-bold [&_h4]:mt-8 [&_h4]:mb-2 [&_h4]:text-amber-200/95 [&_h4]:border-b [&_h4]:border-dashed [&_h4]:border-amber-200/35 [&_h4]:pb-1";
